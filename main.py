...
model = joblib.load('Model.pkl')  # loading the saved RandomForest regressor model
...
def predict():
    ...
    if request.method == "POST":
        # ['age', 'cement', 'water', 'fly_ash', 'coarse aggregate', 'fine aggregate', 'superplasticizer', 'blast_furnace_slag']
